    ...
    <div className="flex flex-col h-full w-full">
      ...
      <div className='flex flex-grow justify-around items-center m-24'>
          ...
          <div className="flex flex-col justify-center items-start">
            ...
            <div className="mr-65 max-w-[40%]">
              <h3 className='text-base font-normal mb-2'>Trackers lurk nearly everywhere.</h3>
      ...
      <div className="order-1 flex flex-col justify-center items-end">
          ...
          <div className="flex flex-col justify-center items-start">
            ...
            <div className="mr-65 max-w-[40%]">
              <h3 className='text-base font-normal mb-2'>They're doing more than just following you around
              with creepy ads.</h3>
